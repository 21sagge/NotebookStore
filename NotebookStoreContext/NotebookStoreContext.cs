...
public class NotebookStoreContext : IdentityDbContext<IdentityUser, IdentityRole, string>
{
	...
	private static void SeedData(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<Brand>().HasData(
			new Brand { Id = 1, Name = "Apple", CreatedAt = now },
			new Brand { Id = 2, Name = "Dell", CreatedAt = now },
			new Brand { Id = 3, Name = "HP", CreatedAt = now },
			new Brand { Id = 4, Name = "Lenovo", CreatedAt = now },
			new Brand { Id = 5, Name = "Microsoft", CreatedAt = now },
			new Brand { Id = 6, Name = "Samsung", CreatedAt = now }
		);

		modelBuilder.Entity<Model>().HasData(
			new Model { Id = 1, Name = "MacBook Pro", CreatedAt = now },
			new Model { Id = 2, Name = "XPS", CreatedAt = now },
			new Model { Id = 3, Name = "Spectre", CreatedAt = now },
			new Model { Id = 4, Name = "ThinkPad", CreatedAt = now },
			new Model { Id = 5, Name = "Surface", CreatedAt = now },
			new Model { Id = 6, Name = "Galaxy Book", CreatedAt = now }
		);

		modelBuilder.Entity<Cpu>().HasData(
			new Cpu { Id = 1, Brand = "Intel", Model = "Core i5", CreatedAt = now },
			new Cpu { Id = 2, Brand = "Intel", Model = "Core i7", CreatedAt = now },
			new Cpu { Id = 3, Brand = "Intel", Model = "Core i9", CreatedAt = now },
			new Cpu { Id = 4, Brand = "AMD", Model = "Ryzen 5", CreatedAt = now },
			new Cpu { Id = 5, Brand = "AMD", Model = "Ryzen 7", CreatedAt = now },
			new Cpu { Id = 6, Brand = "AMD", Model = "Ryzen 9", CreatedAt = now }
		);

		modelBuilder.Entity<Display>().HasData(
			new Display { Id = 1, Size = 13.3, ResolutionWidth = 2560, ResolutionHeight = 1600, PanelType = "IPS", CreatedAt = now },
			new Display { Id = 2, Size = 15.6, ResolutionWidth = 1920, ResolutionHeight = 1080, PanelType = "IPS", CreatedAt = now },
			new Display { Id = 3, Size = 13.3, ResolutionWidth = 1920, ResolutionHeight = 1080, PanelType = "OLED", CreatedAt = now },
			new Display { Id = 4, Size = 14.0, ResolutionWidth = 1920, ResolutionHeight = 1080, PanelType = "IPS", CreatedAt = now },
			new Display { Id = 5, Size = 12.3, ResolutionWidth = 2736, ResolutionHeight = 1824, PanelType = "IPS", CreatedAt = now },
			new Display { Id = 6, Size = 12.0, ResolutionWidth = 2160, ResolutionHeight = 1440, PanelType = "AMOLED", CreatedAt = now }
		);

		modelBuilder.Entity<Memory>().HasData(
			new Memory { Id = 1, Capacity = 8, Speed = 2666, CreatedAt = now },
			new Memory { Id = 2, Capacity = 16, Speed = 2666, CreatedAt = now },
			new Memory { Id = 3, Capacity = 32, Speed = 2666, CreatedAt = now },
			new Memory { Id = 4, Capacity = 8, Speed = 3200, CreatedAt = now },
			new Memory { Id = 5, Capacity = 16, Speed = 3200, CreatedAt = now },
			new Memory { Id = 6, Capacity = 32, Speed = 3200, CreatedAt = now }
		);
