...
namespace NotebookStoreContext.Migrations
{
    ...
    [Migration("20240801125152_RenameNotebookStockTable")]
    partial class RenameNotebookStockTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotebookStore.Entities.NotebookInventory", b =>
                {
            ...
            modelBuilder.Entity("NotebookStore.Entities.NotebookInventory", b =>
                {
                    b.HasOne("NotebookStore.Entities.Notebook", "Notebook")
                        .WithOne()
                        .HasForeignKey("NotebookStore.Entities.NotebookInventory", "NotebookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
