...
namespace NotebookStoreContext.Migrations
{
    ...
    [Migration("20240731133722_AddNotebooksQuantitiesTable")]
    partial class AddNotebooksQuantitiesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotebookStore.Entities.NotebooksQuantities", b =>
                {
            ...
            modelBuilder.Entity("NotebookStore.Entities.NotebooksQuantities", b =>
                {
                    b.HasOne("NotebookStore.Entities.Notebook", "Notebook")
                        .WithOne()
                        .HasForeignKey("NotebookStore.Entities.NotebooksQuantities", "NotebookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
